...
export function ProviderActions({
  ...
  const primeStateChangeHint = t("prime.current.stateUnavailableHint");
  const stateChangeHint =
    appId === "omp" ? ompStateChangeHint : appId === "prime" ? primeStateChangeHint : piStateChangeHint;
  ...
  const deleteHint =
    (appId === "pi" || appId === "omp" || appId === "prime") && isStateChangeProtected
      ? stateChangeHint
      : isReadOnly
        ? readOnlyHint
        : t("common.delete");
