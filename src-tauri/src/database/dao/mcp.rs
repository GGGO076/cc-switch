...
impl Database {
    ...
    pub fn update_mcp_server_app_enabled(
        ...
        let column = match app {
            ...
            AppType::ClaudeDesktop | AppType::OpenClaw | AppType::Pi | AppType::Omp | AppType::Prime => None,
        };
...
mod tests {
    ...
    fn unsupported_mcp_apps_keep_the_existing_noop_semantics() {
        ...
        for app in [AppType::ClaudeDesktop, AppType::OpenClaw, AppType::Pi, AppType::Omp, AppType::Prime] {
            let returned = db
